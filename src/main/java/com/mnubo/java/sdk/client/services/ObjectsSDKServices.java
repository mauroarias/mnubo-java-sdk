...
class ObjectsSDKServices implements ObjectsSDK {
    ...
    @Override
    public List<Map<String, Boolean>> objectsExist(Set<String> deviceIds) {
    ...
    @Override
    public Boolean isObjectExist(String deviceId) {
        ...
        return results == null || results.size() != 1 || results.get("exists") == null ?
                false : results.get("exists");
    }
}
